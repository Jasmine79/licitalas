    ...
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            foreach (Festmeny item in festmenyek)
            {
                ...
                while (merek < 10 || merek > 100)
                {
                    Console.WriteLine("Hibás adatot adott meg. Adjon meg másik értéket kérek.");
                    int.TryParse(Console.ReadLine(), out merek);
                } 
                item.Licit(merek);
            }
...
            Console.WriteLine($"A listában {festmenyek.Count} festmény szerepel.");
        ...
        static void Beolvas()
        {
         StreamReader sr = new StreamReader(@"C:\Users\VidaZsuzsa\source\repos\AukcioProjekt\AukcioProjekt\festmenyek.csv");
        
         /*StreamReader sr = new StreamReader(@"Y:\ESZF\orai_feladatok\
          * Bedando\festmenyek.csv");*/
